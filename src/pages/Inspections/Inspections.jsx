...
export const Inspections = () => {
  ...
  const QuickActionButton = ({ icon: Icon, label, onClick, color = 'emerald' }) => (
    <button
      onClick={onClick}
      className="flex flex-col items-center justify-center p-6 rounded-2xl bg-white shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 min-w-[140px] group"
      style={{
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-emerald-50/30">
      {/* Header */}
      <header className="bg-gradient-to-r from-white to-emerald-50 shadow-2xl">
      ...
      <div className="px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-7 mb-12">
          {[
            ...
            <div key={index} className="bg-gradient-to-br from-white to-gray-50 rounded-2xl p-7 shadow-2xl hover:shadow-3xl transition-all duration-400 hover:-translate-y-2">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-semibold text-gray-600 mb-3">{stat.label}</p>
                  <p className={`text-4xl font-black ${stat.color.includes('rose') ? 'bg-gradient-to-r from-rose-600 to-rose-700 bg-clip-text text-transparent' : 'bg-gradient-to-r from-emerald-600 to-emerald-700 bg-clip-text text-transparent'}`}>
                    {stat.value}
                  </p>
                </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl p-8 shadow-2xl">
              <div className="flex items-center justify-between mb-9">
                <div>
                  <h2 className="text-2xl font-black bg-gradient-to-r from-gray-900 to-emerald-800 bg-clip-text text-transparent">Quick Actions</h2>
                ...
                <div className="flex items-center gap-4">
                  <button className="px-5 py-2.5 text-sm font-bold text-emerald-600 bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-xl hover:from-emerald-100 hover:to-emerald-200 transition-all shadow-md hover:shadow-lg">
                    View All
                  </button>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl p-8 shadow-2xl">
              ...
              <div className="overflow-hidden rounded-2xl shadow-xl">
                <table className="w-full">
                  <thead>
                    <tr className="bg-gradient-to-r from-emerald-50 via-white to-emerald-50">
                      ...
                      <th className="py-5 px-7 text-left text-sm font-black text-gray-700">Date & Time</th>
