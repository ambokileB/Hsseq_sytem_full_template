...
export function Navbar({ toggleSidebar }) {
  ...
  <button 
    className="relative p-2.5 rounded-full cursor-pointer hover:bg-linear-to-br from-amber-50 to-sand/30 transition-all duration-300 group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-400/50 active:scale-95"
    aria-label="Messages (3 unread)"
  >
    {/* Icon with gentle movement */}
    <div className="relative group-hover:animate-gentle-bounce cursor-pointer">
      <MessageSquare className="w-5 h-5 text-camel-brown group-hover:text-amber-800 transition-colors duration-300" />
    </div>
    
    {/* Premium badge with glow */}
    <span className="absolute -top-1 -right-1 min-w-5.5 h-5.5 bg-linear-to-br from-amber-500 via-green-600 to-green-700 text-white text-xs font-bold rounded-full flex items-center justify-center shadow-xl shadow-amber-500/25 border-2 border-white/90">
    ...
    {/* Sun ray effect on hover */}
    <span className="absolute inset-0 rounded-full bg-linear-to-r from-green-200/0 via-green-400/30 to-amber-200/0 opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
  </button>
</PopoverTrigger>
  ...
  >
    {/* Animated bell icon */}
    <div className="relative">
      <Bell className="w-5 h-5 text-muted-foreground group-hover:text-foreground transition-all duration-500 group-hover:rotate-45" />
    </div>
    
    {/* Advanced badge with gradient */}
    <span className="absolute -top-1 -right-1 min-w-5.5 h-5.5 bg-linear-to-br from-yellow-500 to-orange-500 text-white text-xs font-medium rounded-full flex items-center justify-center px-1 shadow-lg border-2 border-background shadow-yellow-500">
      <span className="animate-pulse">7</span>
    </span>
    
    {/* Subtle pulse effect */}
    <span className="absolute inset-0 rounded-full bg-linear-to-r from-green-300 to-yellow-500 animate-pulse opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
